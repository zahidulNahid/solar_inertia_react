...
`absolute inset-0 bg-cover bg-center bg-[${heroImg}]`;
    ...
    return (
        <section className="relative h-[500px]">
            <div
                ...
                style={{
                    backgroundImage:
                        "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/mockup-fundation-A.jpg-FLv18JOPrdGC3yX8R2oS9gdDO65YSW.jpeg')",
                }}
            >
